# ---------------------------------
#
# Created by alex on 07/06/2022 at 23:23
#
# ---------------------------------

# AIMS: Write a script for classifying asteroids
#  based on their visible wavelength reflectance
#  spectra, training it on meteoritic spectra.

# Classifications:

# C-type: albedo 0.03 - 1 asteroid is extremely dark (composition is carbon, iron and other compounds)
# S-type: albedo 0.1 - 0.22 asteroid is lighter (composition is nickel-iron, iron-silicates and magnesium silicates)
# M-type: albedo 0.1 - 0.18 asteroid is similar to S-type (composition is pure nickel-iron)

# ---------------------------------

# Step 1: Create asteroid data set for training and testing
# Step 2: Extract data from dataset
# Step 3: Train program using Naive Bayes algorithm
# Step 4: split data into feature and target variables
# Step 5: Classify each data file in asteroid group type

# ---------------------------------

# Notes:

# Data cant be used raw, several calculation needs to be done
#  such as calculating albedo
# Then data can be parsed into classifier for training

# Data may be able to be used for more specific classification
# More research needed here on how asteroids are classified

# Need to figure out what data represents
